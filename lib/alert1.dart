...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        onPressed:(){
          var rount = MaterialPageRoute(builder: (BuildContext contex) =>Main4()
                  );
        ...
        child: Wrap( 
          ...
          children: <Widget>[
            Container(
              ...
              child: Text("เช็คความถูกต้องของรายงาน",
            ...
            Container(
              ...
              child: OutlineButton(
                ...
                onPressed: (){
                 var rount = MaterialPageRoute(builder: (BuildContext contex) =>Checkhelp()
                  );
                  Navigator.of(context).push(rount);
                  
                },
              child: Text("ข้อความขอความช่วยเหลือ",
              textAlign: TextAlign.center,
              style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700 ,  fontSize: 25, ),
              ),
                ),
